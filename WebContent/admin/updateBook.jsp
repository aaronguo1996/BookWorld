...
<body style="background-color:#D7EDEB">
	...
	<div>
		...
		<div class="right">
			<s:form action="updateBookResult" type="post" namespace="/">
				<label class="reg">Book Name:</label><label class="error"><s:fielderror><s:param>nameError</s:param></s:fielderror></label><br>
				<label><input class="text" type="text" name="book.bookName" value="<s:property value='book.bookName'/>"/></label><br>
				<label class="reg">ISBN:</label><label class="error"><s:fielderror><s:param>isbnError</s:param></s:fielderror></label><br>
				<label><input class="text" type="text" name="book.isbn" value="<s:property value='book.isbn'/>"/></label><br>
				<label class="reg">Writer:</label><label class="error"><s:fielderror><s:param>writerError</s:param></s:fielderror></label><br>
				<label><input class="text" type="text" name="book.writer" value="<s:property value='book.writer'/>"/></label><br>
				<label class="reg">Publisher:</label><label class="error"><s:fielderror><s:param>publisherError</s:param></s:fielderror></label><br>
				<label><input class="text" type="text" name="book.publisher" value="<s:property value='book.publisher'/>"/></label><br>
				<label class="reg">Introduction:</label><label class="error"><s:fielderror><s:param>pubError</s:param></s:fielderror></label><br>
				<label><input class="text" type="text" name="book.intro" value="<s:property value='book.intro'/>"/></label><br>
				<label class="reg">Picture:</label><label class="error"><s:fielderror><s:param>picError</s:param></s:fielderror></label><br>
				<label><input class="text" type="text" name="book.picture" value="<s:property value='book.picture'/>"/></label><br>
				<label class="reg">category</label><label class="error"><s:fielderror><s:param>catError</s:param></s:fielderror></label><br>
				<label><input class="text" type="text" name="book.catagory" value="<s:property value='book.catagory'/>"/></label><br>
				<label class="reg">price</label><label class="error"><s:fielderror><s:param>priceError</s:param></s:fielderror></label><br>
				<label><input class="text" type="text" name="book.price" value="<s:property value='book.price'/>"/></label><br>
				<label class="reg">Publish Year</label><label class="error"><s:fielderror><s:param>yearError</s:param></s:fielderror></label><br>
				<label><input class="text" type="text" name="book.date" value="<s:property value='book.date'/>"/></label><br>
				<label class="reg">Amount</label><label class="error"><s:fielderror><s:param>amountError</s:param></s:fielderror></label><br>
				<label><input class="text" type="text" name="book.remaining" value="<s:property value='book.remaining'/>"/></label><br>
				<input class="menuButton" style="margin-left:50px" type="submit" value="Submit"/>
				<input class="menuButton" style="margin-left:50px" type="button" value="Give Up" onClick="window.location.reload('getBook')"/><br><br>
			</s:form>
		</div>
	</div>
</body>
